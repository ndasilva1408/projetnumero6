...
public interface TOPORepository extends JpaRepository<TOPO,Long> {
   ...
   Page<TOPO> findTOPOSByClimbPathList(List<ClimbPath> climbPathlist,Pageable pageable);
    @Transactional
    TOPO findTOPOSByClimbPathList(List<ClimbPath> climbPathlist);
    ...
    @Transactional
    Page<TOPO> findTOPOSByNameContainsIgnoreCase(@Param("mc") String mc, Pageable pageable);
    @Transactional
    List<TOPO> findTOPOSByNameContainsIgnoreCase(@Param("mc") String mc);
