...
<div class="container">
    ...
    <p>
        Ce site communautaire a pour vocation de mettre en contact les différents membres de l'association et de
        faciliter la venue au personne souhaitant nous rejoindre !
    ...
    <div class="article">
        ...
        <ul>
            ...
            <li>« Lao Tzeu l'a dit : il faut trouver la voie » : c’est le chemin à emprunter par le grimpeur pour
                arriver à destination : le haut de la voie.
            </li>
            ...
            <li>La cotation d’une longueur ou d’une voie, représente sa difficulté. En France, le système de cotation
                va, en gros, par ordre croissant de difficulté, de 3 à 9c. Le chiffre est en quelque sorte, l’unité
                principale et la lettre une sous-unité (de « a » à « c »)
            </li>
            <li>Un topo est un recueil contenant toutes les informations utiles sur les sites d’escalade d’une région
                (les secteurs, les voies, leur hauteur, leur cotation, le nombre de points…). Une bible quoi !
            </li>
        </ul>
    </div>
</div>
...
<footer>
    <b> Nous contacter: AmicaleEscalade@gmail.com / 06.00.00.00.00</b>
</footer>
